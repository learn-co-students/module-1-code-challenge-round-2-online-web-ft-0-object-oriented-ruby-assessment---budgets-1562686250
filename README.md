...
* `department.rb`      - class to represent a city department
...
If there is not already a department with that name and city, `find_or_create` should return a new department.
